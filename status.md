...
| | |
|---|---|
| **`main` HEAD** | `72a1f2a` — **`agent/contracts` merged via PR #3, 2026-09-04** (owner-merged at `c7ba505`; superseded the standing "not yet merged" note that appeared throughout this header and §13 up to this point) |
