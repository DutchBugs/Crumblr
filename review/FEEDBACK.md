...
| The real soak (Phase A/B) | **Phase A not yet run clean to completion** as of this entry — the fourth attempt ran 30 minutes with zero disconnects and 19,437 real ticks persisted, but 0 bars (D-039/D-042 interaction, now fixed) and is not itself evidence of a clean bars run. A fifth attempt, with both fixes present, is the next step. Phase B has not started | — |
